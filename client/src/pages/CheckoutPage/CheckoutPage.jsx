      ...
      <div className="checkout-wrapper">
        <div className="checkout">
              ...
              <div key={uuidv4()} className="item">
                ...
                <div className="controls">
                  <div>
                    <span
                      onClick={() => {
                        if (el?.quantity > 1) {
                          dispatch(decreaseQuantity(el?.info?.id));
                        } else if (el?.quantity === 1) {
                          dispatch(removeFromCart(el?.info?.id));
                        }
                      }}
                      className="btns">
                      <BiMinus />
                    ...
                    <span
                      onClick={() => {
                        dispatch(increaseQuantity(el?.info?.id));
                      }}
                      className="btns">
                      <BiPlus />
                    </span>
                ...
                <div className="price">
                  ...
                  {(el?.info?.price
                    ...
                    : el?.info?.defaultPrice
                    ? (el?.info?.defaultPrice * el?.quantity) / 100
                    : el?.info?.variantsV2?.pricingModels?.[0]?.price / 100
                  ).toLocaleString()}
                </div>
              </div>
          ...
          <div className="price-box">
            <span className="price-tag">Sub Total</span>
          ...
          <div className="price-box">
            <span className="price-tag">GST (3%)</span>
            <span className="price">
              ₹{' '}
              {(
                (cart?.reduce((acc, el) => {
          ...
          <div
            ...
            <button disabled={isOrdering}>
              {isOrdering ? <LoadingIcon className="loading-icon" /> : 'Order'}
            </button>
          </div>
        </div>
      </div>
